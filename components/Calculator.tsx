      ...
      <div className="mt-8 pt-8 border-t-2 border-gray-100">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="result-card p-4 sm:p-5 rounded-xl">
            ...
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 break-words">{formatCurrency(breakdown.hourly)}</div>
          </div>
          <div className="result-card p-4 sm:p-5 rounded-xl">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Daily</div>
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 break-words">{formatCurrency(breakdown.daily)}</div>
          </div>
          <div className="result-card p-4 sm:p-5 rounded-xl">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Weekly</div>
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 break-words">{formatCurrency(breakdown.weekly)}</div>
          </div>
          <div className="result-card p-4 sm:p-5 rounded-xl">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Monthly</div>
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 break-words">{formatCurrency(breakdown.monthly)}</div>
          </div>
        </div>
      </div>
    </div>
