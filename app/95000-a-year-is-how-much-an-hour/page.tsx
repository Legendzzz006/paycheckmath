...
export const metadata: Metadata = {
  title: '$95,000 a Year is How Much an Hour? | PaycheckMath',
  description: 'Convert $95,000 annual salary to hourly, monthly, weekly, and daily pay. See your exact take-home pay breakdown.',
  alternates: {
    canonical: 'https://paycheckmath.com/95000-a-year-is-how-much-an-hour',
  },
  openGraph: {
    title: '$95,000 a Year is How Much an Hour?',
    description: 'Convert $95,000 annual salary to hourly, monthly, weekly, and daily pay.',
    type: 'website',
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:py-12 md:py-16">
        ...
        <section className="mb-16">
          ...
          <RelatedCalculators currentPage="/95000-a-year-is-how-much-an-hour/" />
        </section>
      </main>
